            ...
            <div class="row">
              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <form class="user" action="<?= base_url();?>loginpage" method="post">
                    <div class="form-group mt-3">
                        <label for="user">Masukan Username</label>
                      <input type="text" class="form-control form-control-user" id="user" name="username"
                        aria-describedby="emailHelp" placeholder="Masukan Username Dari Admin">
                        <?php if(validation_errors()):?>
                        <small class="text-danger"><?php echo form_error('username'); ?>
                    </small>
                    <?php endif ;?>
                </div>
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control form-control-user" id="pass"
                        placeholder="Masukan Password Dari admin"  name="password">
                        <?php if(validation_errors()):?>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="#">Jika Anda Lupa Paswword Silahkan Datang Ke Ruang
                      Administrasi</a>
                  </div>
                </div>
              </div>
